...
import com.pasich.mynotes.di.module.BackupActivityModule;
...
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, MainActivityModule.class, NoteActivityModule.class, SearchDialogModule.class, TrashActivityModule.class, MoreNoteModule.class, BackupActivityModule.class})
