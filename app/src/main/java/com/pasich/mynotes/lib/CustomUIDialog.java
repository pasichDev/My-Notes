...
/**
 * A class that simplifies working with dialogs
...
public class CustomUIDialog {
    ...
    /**
     * Method for setting header text
     * uiDialog.setHeadTextView(string);
    ...
    /**
     * The method that returns container
     * Here you need to add container filling
     * builder.setView(uiDialog.getContainer());
     * @return - container
     */
