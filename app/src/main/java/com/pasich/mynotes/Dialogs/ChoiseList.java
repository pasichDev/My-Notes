...
public class ChoiseList extends DialogFragment {
    ...
    public ChoiseList(int pos, ArrayList ListNotesfors, DefaultListAdapter defaultListAdapter, boolean folder, String folderOutput)
    {
        this.pos=pos;
            ...
            switch (which) {
                case 0:
                    ...
                    if(folder==false){
                        ...
                        File folderSelected = new File(getContext().getFilesDir()+"/"+selectedItem+"/");
                        ...
                        updateListView(pos);}
                            ...
                            dilogDeleteFolders.setPositiveButton(getString(R.string.yesDeleteIsFiles), (dialog1, which1) -> {
                                fileCore.deleteFolder(selectedItem);
                                updateListView(pos);
                            });
                ...
                case 1: //Поделиться или переименовать папку
                    if(folder==false){
                        ...
                        folderOption dialogFragment = new folderOption(selectedItem);
                ...
                case 2: //Перместить заметку
                    copyNotes copyNotes = new copyNotes(listNotesfors,defaultListAdapter,selectedItem,pos,folderOutput);
    ...
    private String[] choiseItems(){
        ...
        if (folder==false){
            if(!(fileCore.getCountFolder()==0)){
                returnCH = new String[]{getString(R.string.trashNotes), getString(R.string.share),getString(R.string.copyNotes)};
            }else {
                returnCH = new String[]{getString(R.string.trashNotes), getString(R.string.share)};
            } }
        else { returnCH = new String[]{getString(R.string.deleteFolder), getString(R.string.renameFolder)};}
        return returnCH;
    }
