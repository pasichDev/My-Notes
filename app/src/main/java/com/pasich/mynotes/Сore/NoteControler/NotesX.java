...
public class NotesX {
  ...
  public NotesX(
      Context context,
      EditText editTextToActivity,
      ImageButton buttonEditText,
      String keyFunction,
      ImageButton SpechToTextButton) {
  ...
  /**
   * Метод который изменяет стиль текста окна редактирования заметки Bold,Italic,Normal,Italic-Bold
   *
