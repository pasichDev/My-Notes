...
public class FragmentListNotes extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NotesList.setOnItemClickListener((parent, v, position, id) -> {
        ...
        NotesList.setOnItemLongClickListener((arg0, arg1, position, id) -> {
            ListNotesfor listNotesfor = listNotesfors.get(position);
       ...
       getActivity().findViewById(R.id.newNotesButton).setOnClickListener(v -> {
